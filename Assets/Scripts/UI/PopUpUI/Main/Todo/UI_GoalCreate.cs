...
public class UI_GoalCreate : UI_Popup
{
    ...
    private void ToggleClick(PointerEventData data)
    {
        ...
        {
            showToastMessage(toastMessage, toast, "±×·ì ¸ñÇ¥´Â ºñ°ø°³ÇÒ ¼ö ¾ø½À´Ï´Ù.", 1.2f);
        }
        else
        {
            Managers.Sound.PlayNormalButtonClickSound();
    ...
    private void InfoGather()
    {
        ...
        {
            showToastMessage(toastMessage, toast, "¸ñÇ¥¸¦ ´Ù½Ã ÀÔ·ÂÇØÁÖ¼¼¿ä.", 1.2f);
            return;
        }
    ...
    private void SearchFriendName()
    {
        ...
        if(Util.IsValidString(name, @"^[A-Za-z0-9¤¡-¤¾°¡-ÆR]{1,8}$"))
        {
                ...
                else
                {
                    switch (res.code) {
                        ...
                        case 5030:
                            ...
                            showToastMessage(toastMessage, toast, "ÇØ´çÇÏ´Â Ä£±¸°¡ ¾ø½À´Ï´Ù.", 1.2f);
                            break;
                    }
        ...
        {
            showToastMessage(toastMessage, toast, "¿Ã¹Ù¸¥ ´Ð³×ÀÓÀÌ ¾Æ´Õ´Ï´Ù.",1.2f);
        }
        ...
        if (res != null)
        {
            ...
            else
            {
                switch (res.code)
                {
                    ...
                    case 5007:
                        showToastMessage(toastMessage, toast,"¸ñÇ¥¸¦ ÀÛ¼ºÇØÁÖ¼¼¿ä.",1.2f);
                        break;
                    case 5010:
                        showToastMessage(toastMessage, toast,"¸ñÇ¥¸íÀº 20ÀÚ±îÁö¸¸ ÀÔ·Â°¡´ÉÇÕ´Ï´Ù.", 1.2f);
                        break;
